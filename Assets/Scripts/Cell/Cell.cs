...
public class Cell : MonoBehaviour
{
    ...
    void Update()
    {
        if (UIManager.GetInstance.currUIPanel ==null)
        {
    ...
    public void GenerateRealCell(Vector3 position)//在position位置生成一个real cell
    {
        ...
        {
            if (child.CompareTag("Cell")|| child.CompareTag("Mouth"))
            {
    ...
    void ShowSingleVirtualCell(int i)
    {
        ...
        if (hit2D == true &&
            ...
            hit2D.collider.gameObject.CompareTag("CellBullet")|| hit2D.collider.gameObject.CompareTag("Mouth")))
        {
